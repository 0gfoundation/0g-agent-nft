...
import "./interfaces/IERC7857Legacy.sol";
import "./interfaces/IERC7857MetadataLegacy.sol";
    ...
    IERC7857MetadataLegacy
{
    ...
    function storageInfo(uint256 tokenId) public view virtual returns (string memory) {
        require(_exists(tokenId), "Token does not exist");
